...
| [Trip lifecycle](domain/trip-lifecycle.md) | State machines and invariants | Designed |
...
| [Local development](operations/local-development.md) | Reproducible local environment | Planned |
