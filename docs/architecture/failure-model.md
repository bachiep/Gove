...
| WebSocket disconnect               | Mark UI reconnecting; fetch authoritative REST snapshot (`/trips/current` or `/deliveries/active`); resume only newer events | Browser E2E reconnect scenario        |
