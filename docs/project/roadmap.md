...
Current milestone: **M0 Foundation — Tested locally.** CI has been defined but is not considered verified until the workflow succeeds on GitHub. M1 remains planned.
