...
| RPT-03 | Schema, constraint và invariant                         | [`database-reference.md`](database-reference.md), [`diagrams/data-model.md`](diagrams/data-model.md), `infra/postgres/migrations/0001–0014`                     | Migration catalog, SQL verification queries, và working-tree replay qua `0014` với invariant summary zero-row                       | `Partial`     | Current-baseline backup/restore và final release-commit replay/recovery evidence                  |
...
| RPT-11 | Security, privacy và rate limit                         | `docs/security`, source guards/rate limit, integration tests                                                                                                    | Local origin/payload/quota và ownership evidence                                                                                    | `Partial`     | Final secret/history scan, proxy-aware/multi-instance review và diagnostics exposure review       |
...
| RPT-13 | Local deployment, recovery và rollback                  | `docs/operations`, operation scripts                                                                                                                            | Local Compose, restore drill và isolated rollback evidence                                                                          | `Partial`     | Final-baseline replay/rollback, off-host recovery và named staging evidence                       |
...
Current database evidence: [`migration-replay-2026-09-25.md`](../testing/migration-replay-2026-09-25.md) records the working-tree replay `gove_replay_20260925_ops2` through `0014` and a zero-row invariant summary. The claim remains `Partial` until current-baseline recovery and final release-commit evidence are complete.
